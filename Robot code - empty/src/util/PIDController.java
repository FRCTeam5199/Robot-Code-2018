...
public class PIDController {
	...
	public double update(double position) {
		...
		// Robot.nBroadcaster.println(error + "\t" + integral + "\t" +
		// errorRate);

		// Robot.dashboard.putNumber(name + " p value", p);
		// Robot.dashboard.putNumber(name + " i value", i);
		// Robot.dashboard.putNumber(name + " d value", d);
		// Robot.dashboard.putNumber(name + " integral", integral);

		// Robot.nBroadcaster.println(p * error + "\t" + integral + "\t" + d *
		// errorRate);
