...
public class RobotMap {
	...
	public static int climberChannel = 3;

	public static double AdjustRotationCompensation = .05; // Adjusts 5% per
															// inch off
	public static double AdjustRotationLimit = 1.3; // allows up to 30%
													// compensation, must be >1
	public static double driveForwardEncoderCompensation = .05; // Allows 5% per
																// inch off
	public static double driveForwardEncoderLimit = .7; // Allows up to 30%
	...
	// -9 compensation was determined empirically on concrete and may need
	// adjustment for carpet
	public static double loaderTurnOffSet = -9;
	public static double loaderTurnSpeed = .8;
	public static double loaderTurnAngle = 75;

	// The auton turn 60 function turns 60 degrees 60 is not here because it is
	// in function name
	// We want to have a slower speed, to have an accurate turn
	// These values are determined with a battery above 12.2 volts on concrete
	// floor
